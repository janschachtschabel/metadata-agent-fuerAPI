 ...
 * 
 * Compact layout optimized for browser extension sidebar.
 * Includes input area for text/URL extraction.
 * 
 * Activation:
 * - URL: ?layout=plugin
 * - Attribute: layout="plugin"
 */
@Component({
...
export class PluginLayoutComponent implements OnChanges {
